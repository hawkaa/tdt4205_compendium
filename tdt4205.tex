...
\subsubsection{Items and the LR(0) automaton} % (fold)
...
% paragraph $CLOSURE(I)$ (end)

\paragraph{$GOTO(I,X)$} % (fold)
\label{par:$GOTO(I,X)$}
Is defined to be the closure of the set of all items $[A \to \alpha X.\beta]$ such that $[A \to \alpha .X\beta]$ is in $I$
% paragraph $GOTO(I,X)$ (end)

\paragraph{Use of the LR(0) Automaton} % (fold)
...
% paragraph Use of the LR(0) Automaton (end)

% subsubsection Items and the LR(0) automaton (end)

\subsubsection{The LR-Parsing Algorithm} % (fold)
...
\paragraph{Structure of the LR Parsing Table} % (fold)
...
\end{enumerate}
% paragraph Structure of the LR Parsing Table (end)

\paragraph{Behaviour of the LR Parser} % (fold)
...
% paragraph Behaviour of the LR Parser (end)

% subsubsection The LR-Parsing Algorithm (end)

\subsubsection{Constructing SLR-Parsing Tables} % (fold)
...
\end{enumerate}
% subsubsection Constructing SLR-Parsing Tables (end)
...
\subsubsection{Constructing LALR Parsing Tables} % (fold)
...
% subsubsection Constructing LALR Parsing Tables (end)
...
\subsection{Syntax-Directed Definitions} % (fold)
...
\subsubsection{Inherited and Synthesized Attributes} % (fold)
...
% subsubsection Inherited and Synthesized Attributes (end)

\subsubsection{Evaluating an SDD at the Nodes of a Parse Tree} % (fold)
...
% subsubsection Evaluating an SDD at the Nodes of a Parse Tree (end)

% subsection Syntax-Directed Definitions (end)

\subsection{Evaluation Orders for SDD's} % (fold)
...
\subsubsection{Dependency Graphs} % (fold)
...
% subsubsection Dependency Graphs (end)

\subsubsection{Ordering the Evaluation of Attributes} % (fold)
...
% subsubsection Ordering the Evaluation of Attributes (end)

\subsubsection{S-Attributed Definitions} % (fold)
...
% subsubsection S-Attributed Definitions (end)

\subsubsection{L-Attributed Definitions} % (fold)
...
% subsubsection L-Attributed Definitions (end)

% subsection Evaluation Orders for SDD's (end)
